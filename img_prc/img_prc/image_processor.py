...
class ImageProcessor(Node):
    ...
    #PLaceholder function till background removal implemented
    def process_image_callback(self, goal_handle):
        # Process image once goal is received and execute edge detection
        self.get_logger().info('Processing edge detection...')
        ...
        frame=edge_detection_color(frame,100,150)
        ...
        self.get_logger().info('Done edge detection...')
        return result
    ...
    def timer_callback(self):
        ...
        for (x, y, w, h) in faces:
            ...
            edges = edge_detection_color(face_region, 170, 200)       
